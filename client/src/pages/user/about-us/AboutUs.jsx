                ...
                <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                    ...
                    <div className="order-1 text-right">
                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            ...
                            <button className="flex items-center gap-2 rounded-xl border border-black/10 bg-neutral px-6 py-3 text-sm font-bold text-dark transition-colors hover:border-primary hover:text-primary cursor-pointer">
                                <BookOpen size={16} />
                                <span>اقرأي قصة التأسيس</span>
                            </button>
                        </div>
                    ...
                    <div className="relative order-2">
                        ...
                        <span className="absolute start-6 top-6 flex h-24 w-24 flex-col items-center justify-center gap-1 rounded-full bg-primary text-center text-neutral shadow-md">
                        ...
                        <div className="absolute -bottom-6 start-6 flex items-center gap-3 rounded-2xl bg-neutral px-5 py-3 shadow-md">
                        ...
                        <div className="order-2 text-right lg:order-1">
                            ...
                            <div className="mt-8 flex items-center gap-3">
                                <div className="text-right">
                                    ...
                                    <p className="mt-1 flex items-center gap-2 text-xs font-semibold text-tertiary">
                                        <Award size={14} />
                                        <span>جائزة التميز الحرفي ٢٠٢٣</span>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="mx-auto max-w-7xl px-6 pb-20">
                <div className="rounded-3xl bg-tertiary px-8 py-14 text-center text-neutral">
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        <button className="rounded-xl bg-neutral px-6 py-3 text-sm font-bold text-tertiary shadow-sm transition-colors hover:opacity-90 cursor-pointer">
                            تفضلوا بزيارة البوتيك
                        </button>
                        <button className="flex items-center gap-2 rounded-xl border border-white/30 px-6 py-3 text-sm font-bold text-neutral transition-colors hover:bg-white/10 cursor-pointer">
                            <PartyPopper size={16} />
                            <span>احجزي مع أخصائية الحفلات</span>
                        </button>
                    </div>
                </div>
            </section>
